    ...
    <Layout2>
      ...
      <DestinationSection>
        ...
        <HighLight
          ...
          titleOne="Highlight One"
          descriptionOne="Alitis dolorepra verum excepe vendiciantur re voluptatur? Laboratquo"
          imageTwo={imageQuery.localGuids.childImageSharp.fluid}
          titleTwo="Highlight Two"
          descriptionTwo="Alitis dolorepra verum excepe vendiciantur re voluptatur? Laboratquo"
          imageThree={imageQuery.smallGroups.childImageSharp.fluid}
          titleThree="Highlight Three"
          descriptionThree="Alitis dolorepra verum excepe vendiciantur re voluptatur? Laboratquo"
          imageFour={imageQuery.breathTakingScenery.childImageSharp.fluid}
          titleFour="Highlight Four"
          descriptionFour="Alitis dolorepra verum excepe vendiciantur re voluptatur? Laboratquo"
        />
